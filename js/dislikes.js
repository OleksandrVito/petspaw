...
function getPhoto(data) {  
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        voteIcon.style.background = `url(../icon/dislike-color-20.png) 10px 10px no-repeat`; 
...
function deletePhoto() {
    ...
    .then((data)=> {
       ...
       outputBlock.innerHTML = `<p>Image ID: <span>${this.id}</span> was removed from Dislikes</p>`;
